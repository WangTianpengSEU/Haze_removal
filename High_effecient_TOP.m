...
%  Version 1.0  2019/03/07 By Tianpeng Wang
...
Index = 2;                % The processed images' filename
...
Image_data = ...
imread('H:\Desktop\Master_graduation_design_wtp\MATLAB_project\Haze_removal1\DATA\Haze_image\Other_size\Forest_haze.jpg');
...
[Min_data] = RGB_channels_min_value(Image_R, Image_G, Image_B);        %% about 20% time occupation
...
[Dark_channel_image_original] = Minimum_filter2(Min_data, Minimum_size);  %% about 50% time occupation
...
% tic
[Atmosphere_value] = Atmosphere_estimate(Dark_channel_image_original);  %% about 8% time occupation
% toc
